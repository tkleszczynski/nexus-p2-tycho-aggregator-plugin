...
public interface P2TychoRepositoryAggregator {
    ...
    void enableAggregationFor(P2TychoRepositoryAggregatorConfiguration configuration);

    void disableAggregationFor(P2TychoRepositoryAggregatorConfiguration configuration);
